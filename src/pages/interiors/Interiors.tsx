...
export const Interiors = () => {
  ...
  return (
    <section className="interiors-section container">
      <div className="interiors-section-title-text">
        <div className="interiors-section-title" ref={interiorsRef}>
          <h1>Vítáme Vás ve Světě Interiérů!</h1>
        </div>

        <div className="interiors-section-text">
          <p>
      ...
      <div className="interiors-section-subtitle-text">
        <div className="interiors-section-subtitle">
          <h3>
            Co jsou Interiéry?
          </h3>
        </div>
